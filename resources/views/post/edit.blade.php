                    ...
                    <div class="form">
                        <form action="{{route('post.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="author" type="text" name="author" class="form-control" value="{{$post->author}}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="editorial" type="text" name="editorial" class="form-control" value="{{$post->editorial}}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="pages" type="text" name="pages" class="form-control" value="{{$post->pages}}"/>
